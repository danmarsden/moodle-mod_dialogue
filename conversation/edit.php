...
if ($conversation->state != \mod_dialogue\dialogue::STATE_DRAFT) {
    redirect($returnurl, 'Oh! Ah, yes... I see that you know your judo well...', 2);
}

$form = new \mod_dialogue\form\conversation_form(null, array('data'=>$conversation->prepare_form_data()));// TODO if conversation has rule throw error.
