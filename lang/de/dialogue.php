...
$string['dialoguemessage'] = '{$a->userfrom} hat einen neuen Beitrag im Dialog  \'{$a->dialogue}\' geschrieben. Sie können diesen Beitrag ansehen unter:    {$a->url}'; 
$string['dialoguemessagehtml'] = '{$a->userfrom} hat einen neuen Beitrag geschrieben im Dialog \'<i>{$a->dialogue}</i>\'<br /><br /> Sie können diesen Beitrag ansehen unter <a href="{$a->url}">dialogue</a>.';
