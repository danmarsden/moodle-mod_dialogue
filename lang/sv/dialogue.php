...
$string['dialoguemessage'] = '{$a->userfrom} har skrivit ett nytt inlägg i er dialog \'{$a->dialogue}\'. Du kan läsa dialogen här: {$a->url}';
$string['dialoguemessagehtml'] = '{$a->userfrom} har skrivit ett nytt inlägg i er dialog \'<i>{$a->dialogue}</i>\'<br /><br />Du kan <a href="{$a->url}">läsa dialogen här</a>.';
