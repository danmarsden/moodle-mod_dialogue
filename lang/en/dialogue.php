...
$string['notifications'] = 'Enable notifications';
$string['notifications_help'] = 'Send notifications through Moodle messaging system when conversation created or replied too.';
$string['uimaxrecipients'] = 'UI recipients picker maximum results';
$string['configuimaxrecipients'] = 'Maximum results displayed in recipient picker drop down';
...
$string['createbulkopener'] = 'Create bulk opener';
...
$string['dialogueactions'] = 'Dialogue actions';
...
$string['draft'] = 'Draft';
$string['draftbulkopener'] = 'Draft bulk opener';
...
$string['errorgroupinformation'] = 'You must select a group';
...
$string['hideclosed'] = 'Hide closed';
$string['sortedby'] = 'Sorted by';

$string['organizer'] = 'Organizer';
$string['lastmessageauthor'] = 'Last message author';
$string['filterbyname'] = 'Filter by persons name...';
$string['oneperperson'] = 'One per person - Experimental';
$string['oneperperson_help'] = 'Only one open conversation per recipient';

$string['oneperpersonisset'] = 'This dialogue has been set to only allow one open conversation per person.';
$string['norulesfound'] = 'No rules have been created.';
