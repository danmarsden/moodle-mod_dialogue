...
$string['of'] = 'di';
$string['onwrote'] = 'Su {$a->timestamp} {$a->picture} {$a->author} scrisse';
$string['onyouwrote'] = 'Su {$a->timestamp} {$a->picture} tu scrissi';
$string['open'] = 'Inizia';
...
$string['currentattachment'] = "Allegato corrente: ";
$string['deleteattachment'] = "Elimina allegato";
$string['dialogue:close'] = "Chiudi dialoghi";
$string['dialogue:manage'] = "Gestisci dialoghi";
$string['dialogue:open'] = "Apri dialoghi";
$string['dialogue:participate'] = "Partecipa ai dialoghi";
$string['dialogue:participateany'] = "Partecipa a qualunque dialogo";
$string['dialogue:viewall'] = "Leggi qualunque dialogo";
$string['dialoguebetween'] = 'Dialogo tra {$a->sender} e {$a->recipient} ';
$string['edittime'] = "Tempo massimo di modifica (minuti)";
$string['noentry'] = "Nessun dialogo";
$string['otherdialogues'] = "Altri dialoghi";
