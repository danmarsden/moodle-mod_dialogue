...
/**
 * The mod_dialogue conversation participant added event.
 *
 ...
 */
class conversation_participantadded extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        return "The user with id '$this->userid' has added a participant to the conversation with " .
    ...
    public static function get_name() {
        return get_string('eventconversationparticipantadded', 'mod_dialogue');
    }
