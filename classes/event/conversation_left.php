...
/**
 * The mod_dialogue conversation left event.
 *
 ...
 */
class conversation_left extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        return "The user with id '$this->userid' has left the conversation with " .
    ...
    public static function get_name() {
        return get_string('eventconversationleft', 'mod_dialogue');
    }
